...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("clubCount = ");
        Scanner scn = new Scanner(System.in);
        clubCount = scn.nextInt();
        System.out.printf("leagueCount = ");
        Scanner scn1 = new Scanner(System.in);
        leagueCount = scn1.nextInt();

        Club c[] = new Club[clubCount];
        System.out.printf("clubName = ");
        ...
        System.out.println("*******Inputs for removing Club: ");
        System.out.printf("League Index: ");
        Scanner scn4 = new Scanner(System.in);
        leagueIndex = scn4.nextInt();
        System.out.printf("Club Index: ");
        Scanner scn5 = new Scanner(System.in);
        clubIndex = scn5.nextInt();
