...
public class BySalaryGlobal {
    ...
    @FXML
    private TextField low_salary, high_salary;
    ...
    public BySalaryGlobal(){

    }

    public void SearchPlayerSalary(ActionEvent actionEvent) throws Exception {
        List<Player> found_players = s1.SearchBySalary(Double.parseDouble(low_salary.getText()),Double.parseDouble(high_salary.getText()), main.getPlayerList());
    ...
    public void showAlert() {
        ...
        alert.setContentText("There is no player within the given salary range !");
        alert.showAndWait();
    }
