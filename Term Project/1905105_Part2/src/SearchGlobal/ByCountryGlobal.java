...
public class ByCountryGlobal {
    ...
    @FXML
    private TextField countryName, clubName;
    ...
    public ByCountryGlobal(){

    }

    public void SearchPlayerCountry(ActionEvent actionEvent) throws Exception {
        List<Player> found_players = s1.SearchByClub(clubName.getText(),countryName.getText(), main.getPlayerList());
    ...
    public void showAlert() {
        ...
        alert.setContentText("There is no player with the given country & club name !");
        alert.showAndWait();
    }
