...
public class ByPositionGlobal{
    ...
    public ByPositionGlobal(){

    }

    public void SearchPlayerPosition(ActionEvent actionEvent) throws Exception {
        List<Player> found_players = s1.SearchByPosition(positionName.getText(), main.getPlayerList());
    ...
    public void showAlert() {
        ...
        alert.setContentText("There is no player with the given position name !");
        alert.showAndWait();
    }
