...
public class ByCountry {
    ...
    public void SearchPlayerCountry(ActionEvent actionEvent) throws Exception {
        List<Player> found_players = s1.SearchByClub(Main.userClub.getName(),countryName.getText(), Main.userClub.getPlayerList());
    ...
    public void showAlert() {
        ...
        alert.setContentText("There is no player with the given country name !");
        alert.showAndWait();
    }
